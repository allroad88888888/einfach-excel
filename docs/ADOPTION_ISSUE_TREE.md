...
| -----: | -------------: | -------------------------: | -----------------: | ----------------: |
|    235 |             32 | 1（AD-505 验收契约待明确） |                202 | 5（AD-100/D1~D5） |
...
- AD-000 对外采用与推广（总控）
  ...
  - [**AD-400 定位与可信度**](adoption-issues/AD-400-positioning.md) —— AD-403、AD-404、AD-405、AD-408、AD-410、AD-411、AD-412、AD-420 完成；其余可与 AD-100 并行
