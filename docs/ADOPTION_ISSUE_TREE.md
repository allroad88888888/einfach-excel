...
| -----: | -------------: | -------------------------: | -----------------: | ----------------: |
|    235 |            118 | 1（AD-505 验收契约待明确） |                116 | 5（AD-100/D1~D5） |
...
- AD-000 对外采用与推广（总控）
  ...
  - [**AD-300 框架适配层（React / Vue）**](adoption-issues/AD-300-framework-adapters.md) —— AD-311~325、AD-331~351、AD-354、AD-361~380、AD-391、AD-394 完成；其余独立长线
