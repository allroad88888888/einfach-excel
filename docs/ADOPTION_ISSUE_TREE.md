...
- AD-000 对外采用与推广（总控）
  - [**AD-100 让人装得上（发布链路）**](adoption-issues/AD-100-publish-pipeline.md) —— **首发已完成（2026-08-17，五包 0.1.0 上线并经离体验证）**；AD-101~126、AD-128~130、AD-132~138、AD-142 完成；剩 AD-127（被 AD-414 阻塞）、AD-131（判定待维护者重定义）、AD-139~141、AD-143（AD-142 走查立叶）属质量收尾
