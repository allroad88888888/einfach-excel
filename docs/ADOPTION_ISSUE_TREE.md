...
| -----: | -------------: | -------------------------: | -----------------: | ----------------: |
|    235 |            109 | 1（AD-505 验收契约待明确） |                125 | 5（AD-100/D1~D5） |
...
- AD-000 对外采用与推广（总控）
  ...
  - [**AD-800 规模能力与技术差异化**](adoption-issues/AD-800-scale-differentiation.md) —— AD-801~807、AD-811、AD-814~817、AD-819~827 完成
