...
| -----: | -------------: | -------------------------: | -----------------: | ----------------: |
|    235 |             47 | 1（AD-505 验收契约待明确） |                187 | 5（AD-100/D1~D5） |
...
- AD-000 对外采用与推广（总控）
  ...
  - [**AD-300 框架适配层（React / Vue）**](adoption-issues/AD-300-framework-adapters.md) —— AD-311~316、AD-320~321、AD-325 完成；其余独立长线
  - [**AD-400 定位与可信度**](adoption-issues/AD-400-positioning.md) —— AD-401、AD-403~405、AD-408~412、AD-417~420 完成；其余可与 AD-100 并行
  ...
  - [**AD-800 规模能力与技术差异化**](adoption-issues/AD-800-scale-differentiation.md) —— AD-801~806、AD-811、AD-814、AD-815、AD-821~824 完成
