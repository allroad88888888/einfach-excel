...
- AD-000 对外采用与推广（总控）
  ...
  - [**AD-200 让人五分钟内跑起来**](adoption-issues/AD-200-onboarding.md) —— AD-201~203、AD-205~211 完成（最小示例 20 行实测可跑、Quickstart、五框架配方、UI-core-only 路径）；剩 AD-204（站点对齐）、AD-212~215（模板）、AD-219~220（首次体验走查）
