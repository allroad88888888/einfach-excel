...
| -----: | -------------: | -------------------------: | -----------------: | ----------------: |
|    235 |             84 | 1（AD-505 验收契约待明确） |                150 | 5（AD-100/D1~D5） |
...
- AD-000 对外采用与推广（总控）
  ...
  - [**AD-300 框架适配层（React / Vue）**](adoption-issues/AD-300-framework-adapters.md) —— AD-311~325、AD-331~335、AD-337~338、AD-361~365、AD-367~368 完成；其余独立长线
  ...
  - [**AD-800 规模能力与技术差异化**](adoption-issues/AD-800-scale-differentiation.md) —— AD-801~806、AD-811、AD-814~817、AD-819~826 完成
...
- AD-823 已完成现状复核，AD-821/822/824 的完成状态以该复核后的契约为准；AD-825~826 已完成可复跑实测，AD-827~829 仍缺成本对照或远程路径演示，不能声称具体传输或计算优势。
