...
| -----: | -------------: | -------------------------: | -----------------: | ----------------: |
|    235 |            131 | 1（AD-505 验收契约待明确） |                103 | 5（AD-100/D1~D5） |
...
- AD-000 对外采用与推广（总控）
  - [**AD-100 让人装得上（发布链路）**](adoption-issues/AD-100-publish-pipeline.md) —— 硬阻塞；AD-122、AD-123、AD-125、AD-126、AD-128 完成；其余尚未闭环
