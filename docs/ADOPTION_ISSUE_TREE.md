...
- AD-000 对外采用与推广（总控）
  - [**AD-100 让人装得上（发布链路）**](adoption-issues/AD-100-publish-pipeline.md) —— 硬阻塞；口径已裁决（ADR 0014~0019）；AD-101~126、AD-128~130、AD-133、AD-136~137 完成；AD-132 局部进展（等 NPM_TOKEN 首跑）；剩 AD-127（被 AD-414 阻塞）、AD-131、AD-134~135、AD-138~142
