...
| -----: | -------------: | -------------------------: | -----------------: | ----------------: |
|    235 |             50 | 1（AD-505 验收契约待明确） |                184 | 5（AD-100/D1~D5） |
...
- AD-000 对外采用与推广（总控）
  ...
  - [**AD-800 规模能力与技术差异化**](adoption-issues/AD-800-scale-differentiation.md) —— AD-801~806、AD-811、AD-814~816、AD-821~824 完成
