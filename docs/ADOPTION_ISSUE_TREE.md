...
- AD-000 对外采用与推广（总控）
  - [**AD-100 让人装得上（发布链路）**](adoption-issues/AD-100-publish-pipeline.md) —— 硬阻塞；口径已裁决（ADR 0014~0018）；AD-101~114、AD-122、AD-123、AD-125、AD-126、AD-128 完成；其余尚未闭环
