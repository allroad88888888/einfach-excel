...
- AD-000 对外采用与推广（总控）
  - [**AD-100 让人装得上（发布链路）**](adoption-issues/AD-100-publish-pipeline.md) —— 硬阻塞；口径已裁决（ADR 0014~0019）；AD-101~126、AD-128~130、AD-136~137 完成；剩 AD-127、AD-131~135、AD-138~142
