...
| -----: | -------------: | -------------------------: | -----------------: | ----------------: |
|    235 |             20 | 1（AD-505 验收契约待明确） |                214 | 5（AD-100/D1~D5） |
...
- AD-000 对外采用与推广（总控）
  ...
  - [**AD-700 承接进来的人**](adoption-issues/AD-700-community.md) —— AD-701、AD-702、AD-706、AD-708、AD-709 完成
  - [**AD-800 规模能力与技术差异化**](adoption-issues/AD-800-scale-differentiation.md) —— AD-801~805、AD-821~824 完成
