...
- AD-000 对外采用与推广（总控）
  ...
  - [**AD-800 规模能力与技术差异化**](adoption-issues/AD-800-scale-differentiation.md) —— AD-801~807、AD-810~811、AD-813~817、AD-819~829 完成（812 进行中）;剩 AD-808~809（进行中）、AD-812、AD-818（条件未满足）
