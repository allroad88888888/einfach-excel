...
| -----: | -------------: | -------------------------: | -----------------: | ----------------: |
|    235 |            102 | 1（AD-505 验收契约待明确） |                132 | 5（AD-100/D1~D5） |
...
- AD-000 对外采用与推广（总控）
  ...
  - [**AD-300 框架适配层（React / Vue）**](adoption-issues/AD-300-framework-adapters.md) —— AD-311~325、AD-331~345、AD-351、AD-361~375 完成；其余独立长线
