...
| -----: | -------------: | -------------------------: | -----------------: | ----------------: |
|    235 |             65 | 1（AD-505 验收契约待明确） |                169 | 5（AD-100/D1~D5） |
...
- AD-000 对外采用与推广（总控）
  ...
  - [**AD-300 框架适配层（React / Vue）**](adoption-issues/AD-300-framework-adapters.md) —— AD-311~325、AD-331~332、AD-361~362 完成；其余独立长线
  - [**AD-400 定位与可信度**](adoption-issues/AD-400-positioning.md) —— AD-401、AD-403~407、AD-408~412、AD-416~420 完成；其余可与 AD-100 并行
