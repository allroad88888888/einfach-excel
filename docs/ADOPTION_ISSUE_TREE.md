...
| -----: | -------------: | -------------------------: | -----------------: | ----------------: |
|    235 |            125 | 1（AD-505 验收契约待明确） |                109 | 5（AD-100/D1~D5） |
...
- AD-000 对外采用与推广（总控）
  ...
  - [**AD-300 框架适配层（React / Vue）**](adoption-issues/AD-300-framework-adapters.md) —— AD-311~325、AD-331~354、AD-361~384、AD-391、AD-392、AD-394 完成；其余独立长线
