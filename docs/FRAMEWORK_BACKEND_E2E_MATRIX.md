...
| ----- | ----------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------ | --------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------ |
| React | 调用方持有的受控 fixture：确定性、冻结的 `SpreadsheetBackend` 和 store；不是 engine、worker 或 WASM 后端。                          | [react-adapter.spec.ts](../excel/react-excel/e2e/adapter-selection/react-adapter.spec.ts)；[CASES.md](../excel/react-excel/e2e/adapter-selection/CASES.md)                                                        | [R-TC](#r-tc)、[R-E2E](#r-e2e) | Chromium 中从首个单元格拖到右下单元格；公共选择 hook、受控网格选区及范围读数随之更新。                          | 不涵盖 worker/WASM、剪贴板、站点演示、其他浏览器或框架×后端组合。  |
