    ...
    <aside class="performance-hud" aria-label="Live performance measurements">
      ...
      <dl>
        ...
        <div>
          ...
          <dd>{formatProjectionDuration(metrics().projectionDurationMs)}</dd>
        </div>
      </dl>
...
function formatProjectionDuration(projectionDurationMs: number | null): string {
  return projectionDurationMs === null ? 'Waiting' : `${projectionDurationMs.toFixed(1)} ms`
}
