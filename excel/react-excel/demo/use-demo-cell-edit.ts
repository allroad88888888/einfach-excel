...
/** Connects the demo cell editor to UI-core's acknowledged Rust mutation command. */
export function useDemoCellEdit(viewport: UseSpreadsheetViewportResult): DemoCellEdit {
