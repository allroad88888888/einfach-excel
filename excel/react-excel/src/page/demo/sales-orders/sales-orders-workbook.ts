...
import { SALES_ORDER_SUMMARY_CELLS, SUMMARY_SIZES, SUMMARY_VISIBILITY } from './data/summary-seed'
...
export const SALES_ORDERS_WORKBOOK_DEFINITION: RustWorkbookDefinition = Object.freeze({
  ...
  sheets: Object.freeze([
    ...
    { id: 'summary', name: 'Summary', rowCount: 100, colCount: 8, ...SUMMARY_SIZES, ...SUMMARY_VISIBILITY },
  ]),
