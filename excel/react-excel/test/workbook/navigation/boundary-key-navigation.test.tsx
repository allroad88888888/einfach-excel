...
describe('workbook boundary-key navigation', () => {
  ...
  it('physically exposes the complete last row despite scrollbar rounding', async () => {
    ...
    const scrollHeight = (SALES_ORDER_SHEET_ROW_COUNT + 1) * WORKBOOK_GRID_ROW_HEIGHT + 1
