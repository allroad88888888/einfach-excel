...
export function ValidationRuleFields(props: ValidationRuleFieldsProps) {
  return (
    <div class="dv-rule-form" data-testid="validation-rule-form">
      <div class="dv-form-row">
        <label for="validation-kind-select">{props.translate('dataValidation.ruleType')}</label>
        <select
      ...
      <Show when={props.form().kind === 'list'}>
        <div class="dv-form-row">
          <label for="validation-list-values">{props.translate('dataValidation.values')}</label>
          <input
      ...
      <Show when={props.form().kind === 'regex'}>
        <div class="dv-form-row">
          <label for="validation-regex-pattern">{props.translate('dataValidation.pattern')}</label>
          <input
      ...
      <Show when={props.form().kind === 'formula'}>
        <div class="dv-form-row">
          <label for="validation-formula-text">{props.translate('dataValidation.formula')}</label>
          <input
      ...
      <div class="dv-form-row">
        <label for="validation-mode-select">{props.translate('dataValidation.mode')}</label>
        <select
