...
export const messages: Record<string, string> = {
  ...
  'printPreview.worksheetPreview': 'Worksheet preview',
  'printPreview.settings': 'Print settings',
  'printPreview.orientation.label': 'Orientation',
  'printPreview.orientation.portrait': 'Portrait',
  'printPreview.orientation.landscape': 'Landscape',
  'printPreview.scaling.label': 'Scaling',
  'printPreview.scaling.fit': 'Fit to pages',
  'printPreview.scaling.fitDimensions': 'Fit {dimensions}',
  'printPreview.scaling.pagesWide': '{count} page(s) wide',
  'printPreview.scaling.pagesTall': '{count} page(s) tall',
  'printPreview.pageBreaks': 'Page breaks',
  'printPreview.action.print': 'Print',
  'printPreview.action.close': 'Close preview',
  'printPreview.action.pageSetup': 'Page setup',
  ...
  'status.aggregate.menuLabel': 'Status bar aggregates',
  'status.aggregate.pickerHint': 'Right-click to choose which aggregates to show',
