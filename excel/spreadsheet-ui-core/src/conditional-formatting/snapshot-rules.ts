    ...
    switch (value.kind) {
      case 'cell-value': {
        ...
        return {
          ...
          value: value.value,
          ...(value.value2 === undefined ? {} : { value2: value.value2 }),
          format,
        }
      }
      case 'formula': {
        const format = snapshotFormat(value.format)
        return typeof value.formula === 'string' && format !== null
          ? { kind: value.kind, formula: value.formula, format }
          : null
      }
      case 'data-bar':
        return (value.minColor !== undefined && typeof value.minColor !== 'string') ||
          (value.maxColor !== undefined && typeof value.maxColor !== 'string')
          ? null
          : {
              kind: value.kind,
              ...(value.minColor === undefined ? {} : { minColor: value.minColor }),
              ...(value.maxColor === undefined ? {} : { maxColor: value.maxColor }),
            }
      case 'color-scale':
        return typeof value.minColor !== 'string' ||
          typeof value.maxColor !== 'string' ||
          (value.midColor !== undefined && typeof value.midColor !== 'string')
          ? null
          : {
              kind: value.kind,
              minColor: value.minColor,
              ...(value.midColor === undefined ? {} : { midColor: value.midColor }),
              maxColor: value.maxColor,
            }
      case 'top-bottom': {
        const format = snapshotFormat(value.format)
        if (
          (value.direction !== 'top' && value.direction !== 'bottom') ||
          typeof value.count !== 'number' ||
          !Number.isFinite(value.count) ||
          (value.percent !== undefined && typeof value.percent !== 'boolean') ||
          format === null
        )
          return null
        return {
    ...
    return {
      ...
      rules:
        rules.length > CONDITIONAL_FORMAT_RULES_MAX
          ? rules.slice(-CONDITIONAL_FORMAT_RULES_MAX)
          : rules,
