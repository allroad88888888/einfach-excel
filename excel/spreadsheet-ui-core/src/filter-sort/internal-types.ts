...
import type { HistoryEntry, HistoryEntryRecorder, HistoryProducerReservation } from '../history'
...
export interface FilterSortEntrypointTicketBase {
...
export interface ReapplyFilterTicket extends FilterSortEntrypointTicketBase {
...
export interface PhysicalSortTicket extends FilterSortEntrypointTicketBase {
...
export type FilterSortEntrypointTicket = ReapplyFilterTicket | PhysicalSortTicket
export type BoundedOperationResult<T> =
  | { readonly kind: 'fulfilled'; readonly value: T }
  | { readonly kind: 'rejected'; readonly error: unknown }
  | { readonly kind: 'timeout' }
export type FilterSortAcknowledgementSnapshot =
  | {
...
export type PhysicalSortAcknowledgement =
  | {
