...
export function setCommandError(set: Setter, value: SpreadsheetError): void {
...
export function acceptSearchResult(
  set: Setter,
  ticket: SearchTicket,
  accepted: NonNullable<ReturnType<typeof validateSearchResult>>,
