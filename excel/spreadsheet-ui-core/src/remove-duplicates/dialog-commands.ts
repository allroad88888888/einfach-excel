...
import {
  ...
  removeDuplicatesCellsStateAtom,
  removeDuplicatesComparisonStateAtom,
  removeDuplicatesErrorStateAtom,
  removeDuplicatesExcludeHeaderStateAtom,
  removeDuplicatesKeyColumnsStateAtom,
  removeDuplicatesLifecycleAtom,
  removeDuplicatesLifecycleStateAtom,
  removeDuplicatesOpenStateAtom,
  removeDuplicatesRangeStateAtom,
  removeDuplicatesRangeAtom,
  removeDuplicatesSessionSequenceStateAtom,
  removeDuplicatesSessionStateAtom,
} from './state'
import type {
...
export function closeSession(get: Getter, set: Setter): void {
    ...
    switch (intent.kind) {
      case 'toggle-key-column': {
        if (
          ...
          return false
        const next = new Set(get(removeDuplicatesKeyColumnsStateAtom))
