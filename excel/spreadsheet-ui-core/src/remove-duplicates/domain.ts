...
export function snapshotRuntimeValue<Value>(
  value: Value,
...
export function snapshotCells(cells: readonly DisplayCell[]): readonly DisplayCell[] {
  return snapshotRuntimeValue(Array.from(cells))
}
export function snapshotRange(range: CellRange): Readonly<CellRange> {
...
export function snapshotRemoveDuplicatesRange(range: RemoveDuplicatesRange): RemoveDuplicatesRange {
  return Object.freeze({
...
export function toRemoveDuplicatesRange(range: CellRange): RemoveDuplicatesRange {
...
export function validRange(range: CellRange): boolean {
  return (
...
export function validRevision(revision: unknown): revision is ProjectionRevision {
  return (
...
export async function withRemoveDuplicatesTimeout<Value>(
...
export function normalizeRemoveDuplicatesTimeout(timeoutMs: unknown): number {
...
export function lifecycleFor(
  ...
  return Object.freeze({ status, sessionId, readRequestId, mutationRequestId, sheetId })
}
export function snapshotScanResult(result: RemoveDuplicatesScanResult): RemoveDuplicatesScanResult {
  return Object.freeze({
    ...result,
...
export function allColumnsInRange(range: RemoveDuplicatesRange): ReadonlySet<number> {
