...
export function readTicketContextIsCurrent(
  get: Getter,
...
export type ReadAcknowledgementClassification =
  | Readonly<{ status: 'exact'; acknowledgement: ExactReadAcknowledgementSnapshot }>
...
export function classifyReadAcknowledgement(
