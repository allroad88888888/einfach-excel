...
export interface RemoveDuplicatesReadTicket {
  readonly sessionId: number
  readonly requestId: ProjectionRequestId
  readonly sheetId: string
  readonly range: Readonly<{ rowStart: number; rowEnd: number; colStart: number; colEnd: number }>
...
export interface RemoveDuplicatesMutationTicket {
  readonly sessionId: number
  readonly selectionWitness: SelectionAuthorityWitness
  readonly workspaceActiveSheetWitness: WorkspaceActiveSheetAuthorityWitness
...
export const removeDuplicatesLifecycleStateAtom =
  atom<RemoveDuplicatesLifecycleState>(INITIAL_LIFECYCLE)
export const removeDuplicatesCapabilityStateAtom =
...
for (const [state, label] of [
  [removeDuplicatesOpenStateAtom, 'open.state'],
  [removeDuplicatesRangeStateAtom, 'range.state'],
  [removeDuplicatesCellsStateAtom, 'cells.state'],
  [removeDuplicatesKeyColumnsStateAtom, 'keyColumns.state'],
  [removeDuplicatesComparisonStateAtom, 'comparison.state'],
  [removeDuplicatesExcludeHeaderStateAtom, 'excludeHeader.state'],
  [removeDuplicatesSessionStateAtom, 'session.state'],
  [removeDuplicatesLifecycleStateAtom, 'lifecycle.state'],
  [activeRemoveDuplicatesReadAtom, 'activeRead'],
  [activeRemoveDuplicatesMutationAtom, 'activeMutation'],
] as const)
  state.debugLabel = `spreadsheet.removeDuplicates.${label}`
for (const [state, label] of [
  [removeDuplicatesOpenAtom, 'open'],
  [removeDuplicatesRangeAtom, 'range'],
  [removeDuplicatesScanInputCellsAtom, 'scanInputCells'],
  [removeDuplicatesKeyColumnsAtom, 'keyColumns'],
  [removeDuplicatesComparisonAtom, 'comparison'],
  [removeDuplicatesExcludeHeaderAtom, 'excludeHeader'],
  [removeDuplicatesSessionAtom, 'session'],
  [removeDuplicatesLifecycleAtom, 'lifecycle'],
  [removeDuplicatesCapabilityAtom, 'capability'],
  [removeDuplicatesErrorAtom, 'error'],
  [removeDuplicatesPreviewAtom, 'preview'],
] as const)
  state.debugLabel = `spreadsheet.removeDuplicates.${label}`
