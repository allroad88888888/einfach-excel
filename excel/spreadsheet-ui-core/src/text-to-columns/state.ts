...
export const textToColumnsSourceStateAtom = atom<readonly TextToColumnsSourceRow[]>(
...
export const textToColumnsLifecycleStateAtom = atom<TextToColumnsLifecycleState>(
...
export const textToColumnsEntrypointStateBackingAtom = atom<TextToColumnsEntrypointState>(
...
export const textToColumnsPreviewAtom = atom((get): readonly TextToColumnsPreviewRow[] =>
  createTextToColumnsPreview(
    ...
    effectiveTextToColumnsConfig(get(textToColumnsWizardAtom), {
...
export const textToColumnsNextBlockReasonAtom = atom((get) =>
  nextBlockReason(get(textToColumnsWizardAtom)),
)
...
export const textToColumnsCanFinishAtom = atom((get) => {
  ...
  return (
    get(textToColumnsCapabilityAtom) &&
    get(textToColumnsHasSourceAtom) &&
    wizard.step === 'step-3' &&
