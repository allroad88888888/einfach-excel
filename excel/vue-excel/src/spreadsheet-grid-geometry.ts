...
/** Sparse dimensions used to calculate one Vue grid's coordinate space. */
...
/** Pure coordinate snapshot a Vue grid can render without owning UI state. */
 ...
 *
 * This deliberately has no DOM, Vue, projection, or product-state concerns.
 */
